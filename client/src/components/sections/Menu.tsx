...
const menuItems = {
  clasicas: [
    ...
    { id: 50, name: 'Mitad de Cada Una', desc: 'Escoge 2 pizzas diferentes y lleva mitad de cada una. El precio es la suma del 50% de cada pizza según el tamaño.', price: 35000, tags: ['popular'], image: null },
  ],
  especiales: [
